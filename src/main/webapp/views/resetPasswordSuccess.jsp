...
<div class="jumbotron text-center" style="margin-bottom:0;width: 100%;height: 100%;background: #3cb371">
    <h1 style="color: #ffffff;margin-top: 10%">Reset Password Success!</h1>
    <p style="color: #ffffff">Please login Crazyb's Home By your new password, <span id="time">3</span> second before redirect ...</p>
</div>
